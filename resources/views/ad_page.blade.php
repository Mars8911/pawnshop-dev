...
<body>
        ...
        <div class="c-top-header__toolbar-bar">
            <div class="c-top-header__container">
                <div class="c-top-header__toolbar">
                    ...
                    <a href="index.html" class="c-top-header__toolbar-link c-top-header__toolbar-link--home">返回首頁</a>
                </div>
            </div>
        </div>
        <div class="c-top-header__container">
            <div class="row align-items-center g-3">
                <div class="col-12 col-md-auto text-center text-md-start">
                    <a href="index.html" class="c-top-header__logo-link">
                        <img src="{{ asset('img/logo.gif') }}" alt="台灣借錢網" class="c-top-header__logo img-fluid">
                    </a>
                </div>
                <div class="col-12 col-md text-center text-md-end">
                    <a href="#" class="c-top-header__ad-link">
                        <img src="{{ asset('img/logor.gif') }}" alt="廣告刊登" class="c-top-header__ad-image img-fluid">
                    </a>
                </div>
            </div>
        </div>
    ...
    <nav class="c-mobile-nav">
      <div class="c-mobile-nav__container">
        <a href="index.html" class="c-mobile-nav__home-icon" aria-label="返回首頁">
